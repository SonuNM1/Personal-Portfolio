export default function Data() {
    ...
    return (
        ...
        <div className="home__data">
            <h1 className="home__title">Sonu N. Mahto
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Full Stack Developer building scalable web applications. Scalable systems. Clean architecture.</p>

            <a href="#contact" className="button button--flex" aria-label="Scroll to contact section">
                Get in Touch
                <svg
